...
function taskPostUrl(function_id, body = {}, function_id2) {
  ...
  return {
    url,
    body: `functionId=${function_id}&body=${escape(JSON.stringify(body))}&client=wh5&clientVersion=1.0.0&uuid=${UUID}`,
    headers: {
