...
async function getCoupons(shareCode = '', type = 1) {
  return new Promise((resolve) => {
    let body = encodeURIComponent(JSON.stringify({"platform":4,"unionActId":"31149","actId":$.actId,"d":$.code,"unionShareId":shareCode,"type":type,"eid":$.eid}))
